    ...
    return (
        <>
            <div className={'container-landing'}>
                <div className="navBar">
                    <div className="nav-box">
                        ...
                        <div className={isActive ? "nav-content active" : "nav-content"}>
                            <ul>
                                <li><a href="#team">For Yourself</a></li>
                                <li><a href="#team">For Teams</a></li>
                                <li><a href="#product">Products</a></li>
                                <li><a href="#tutroil">Tutorials</a></li>
                            </ul>
                        </div>
                        <div className="nav-component">
                            ...
                            <div className="menu" onClick={handleClick}>
                                {isActive ?
                                    <svg className={"x"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="25px"
                                         height="25px">
                                        <path
                ...
                <div className="info">
                    <div className="info-box">
                        ...
                        <div className="right-el">
                            ...
                            <p>Our product is designed to simplify the way you share all the necessary information about
                                yourself with others. No more fumbling with business cards or manually typing in contact
                                details. With a single click, you can instantly share your complete profile, making
                                networking and connecting with others a breeze.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="func-box">
                        <div className="func-title">
                            ...
                            <div className="func-type">
                                {funcIsActive ? <div>
                                        <h3>Yourself</h3>
                                        <h3 onClick={funcBox} style={{background: 'white'}}>Team</h3>
                                    </div>
                                    :
                                    <div>
                                        <h3 onClick={funcBox} style={{background: 'white'}}>Yourself</h3>
                                        <h3>Team</h3>
                                    </div>
                                }
                            </div>
                                ...
                                {funcIsActive ?
                                    <div className="func-left">
                                        <div className="func-left-el">
                                            <h1>Create and customize your digital profile in minutes123.</h1>
                                            <p>Our product is designed to simplify the way you share all the necessary
                                                information about yourself with others.</p>
                                        </div>
                                        <div className="func-left-el">
                                            <h1>Create and customize your digital profile in minutes.</h1>
                                            <p>Our product is designed to simplify the way you share all the necessary
                    ...
                    <div className="launch-box">
                        <div className="launch-item">
                            ...
                            <div className="launch-text">
                                <p>Choose the product you like and provide minimal information such as your name, email,
                                    phone number, and job title to get started.</p>
                            </div>
                        </div>
                        <div className="launch-item">
                            <div className="launch-step">
                            ...
                            <div className="launch-text">
                                <p>Enter our web platform to add all additional information and add your style to your
                                    profile. It all comes together in a link designed in the landing page format.</p>
                            </div>
                        </div>
                        <div className="launch-item">
                            <div className="launch-step">
                            ...
                            <div className="launch-text">
                                <p>The web platform allows you to store and edit your profile, and in an offline gathering,
                                    you can easily share your business card in one click with our product.</p>
                            </div>
                        </div>
                ...
                <div className="info" id={'product'}>
                    <div className="info-box">
                        <div className="left-el">
                            ...
                            <p>Join us in our mission to create a greener world by embracing the our product. Say goodbye to
                                wasteful paper business cards and join the sustainable revolution. With our product, you can
                                instantly exchange your profile information, making networking eco-friendly and efficient.
                                You can make a positive impact on the environment while effortlessly sharing your
                                profile.</p>
                ...
                <footer className={props.className} style={{ fontFamily: "Rubik" }}>
                    <div className="footer-container">
                        <div className="footer-main">
                            <div className="footer-text">
                                <Text className="footer-text-content" size="txtRubikRegular16">
                                    Заряжайте свой автомобиль быстрее, удобнее и дешевле с нами.
                                </Text>
                            </div>
                            <div className="footer-links">
                                <div className="footer-links-column">
                                    <Text className="footer-links-header" size="txtRubikMedium24">
                                        Links
                                    </Text>
                        ...
                        <div className="footer-bottom">
                            ...
                            <div className="footer-logo">
                                <Text className="footer-logo-text" size="txtRubikRegular14">
                                    eCARchargers
                                </Text>
