...
export const ADMIN_LAYOUT_ROUTE = "/admin/layout";
...
export const PRIVATE_ROUTE4 = '/private4';
export const PRIVATE_ROUTE5 = '/private5';
export const PRIVATE_ROUTE6 = '/private6';
